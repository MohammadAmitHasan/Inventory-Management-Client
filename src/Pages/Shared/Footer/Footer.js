...
const Footer = () => {
    return (
        <div className='p-10 bg-slate-900 mt-10'>
                ...
                <div className='lg:col-span-2 flex items-center justify-center md:justify-start'>
                    <div className='w-72'>
                        ...
                        <div className='pt-1 text-center'>
                            <h4 className='text-xl font-semibold text-red-400'>Nasah Inventory Management</h4>
                        </div>
                    </div>
                </div>
            ...
            <p className='text-center mt-10'>
                <small>Copyright &copy; {new Date().getFullYear()}, Nasah Inventory Management, All rights reserved</small>
            </p>
        </div>

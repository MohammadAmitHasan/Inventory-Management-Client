...
const Products = () => {
    ...
    return (
        <div className='mt-32 md:mt-10 mb-10 container mx-auto p-5'>
            ...
            <Link className='text-lg px-5 py-2 w-1/4 w-60 mx-auto rounded-full flex font-semibold justify-center items-center bg-red-600 hover:bg-red-700' to={'manageProducts'}>Manage Inventories
